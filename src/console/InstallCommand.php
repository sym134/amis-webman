...
class InstallCommand extends Command
{
    ...
    {
        $this->directory = config('plugin.jizhi.admin.admin.directory');
    }
    ...
    public function createHomeController(): void
    {
        ...
        $this->laravel['files']->put(
            $homeController,
            str_replace('{{Namespace}}', config('plugin.jizhi.admin.admin.route.namespace'), $contents)
        );
    ...
    {
        $base = str_replace('\\controller', '\\', config('plugin.jizhi.admin.admin.route.namespace'));
