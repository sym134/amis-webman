...
use jizhi\admin\support\cores\Api;
...
class ApiController extends AdminController
{
    ...
    public function addTemplate(): Response
    {
        ...
        if (!$className) {
            $className = Str::between($template, 'class ', ' extends \jizhi\admin\support\apis\AdminBaseApi');
        }
    ...
    {
        $apis = collect(\support\Container::instance('jizhi.admin')->get('apis'))
