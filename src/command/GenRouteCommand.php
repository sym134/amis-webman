...
//         });
    ...
    public function putPlugin($plugin_name, $content): void
    {
        ...
        // 引入自动路由
        if (!str_contains($root_route_content, 'require_once app_path($plugin_name.\'/app/route/autoRoute.php\');')) {
            $root_route_content .= "\n// 加载应用下的路由配置\nrequire_once plugin_path('$plugin_name/app/route/autoRoute.php');";
